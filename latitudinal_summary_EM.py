...
imageOfInterest = imageOfInterest.unitScale(ee.Number(minMaxDict.get('ectomycorrhizal_richness_Predicted_min')), ee.Number(minMaxDict.get('ectomycorrhizal_richness_Predicted_max')))
...
if __name__ == '__main__':
        ...
        with poolcontext(NPROC) as pool:
                ...
                results.to_csv("output/"+today+"_ectomycorrhizal_latitude_summary.csv")
