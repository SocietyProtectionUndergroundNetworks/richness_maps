...
imageOfInterest = ee.Image('users/camillefournier-de-lauriere/RPRS_pilotmaps2').select('Sabatini2022_VegetationRichness')
...
imageOfInterest = imageOfInterest.unitScale(ee.Number(minMaxDict.get('Sabatini2022_VegetationRichness_min')), ee.Number(minMaxDict.get('Sabatini2022_VegetationRichness_max')))
...
if __name__ == '__main__':
        ...
        with poolcontext(NPROC) as pool:
                ...
                results.to_csv("output/"+today+"_Sabatini2022_VegetationRichness_latitude_summary.csv")
