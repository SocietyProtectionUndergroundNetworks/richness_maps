...
projectFolder = '000_SPUN_GFv4_5/' + guild
...
predObs_df = GEE_FC_to_pd(ee.FeatureCollection('users/johanvandenhoogen/000_SPUN_GFv4_4/ectomycorrhizal/ectomycorrhizal_richness_pred_obs'))
...
predObs_df.to_csv('output/20230125'+classProperty+'_pred_obs.csv')
