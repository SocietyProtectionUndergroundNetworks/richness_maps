...
imageOfInterest = ee.Image('users/johanvandenhoogen/000_SPUN_GFv4_6/arbuscular_mycorrhizal_non_log/arbuscular_mycorrhizal_richness_classifiedImage_zeroInflated').select('arbuscular_mycorrhizal_richness_Predicted')
...
imageOfInterest = imageOfInterest.unitScale(ee.Number(minMaxDict.get('arbuscular_mycorrhizal_richness_Predicted_min')), ee.Number(minMaxDict.get('arbuscular_mycorrhizal_richness_Predicted_max')))
...
if __name__ == '__main__':
        ...
        with poolcontext(NPROC) as pool:
                ...
                results.to_csv("output/"+today+"_arbuscular_mycorrhizal_latitude_summary.csv")
