...
# Training data file is written from spatial_predictors/1_dbMEMs_AMF_create_export.R
localPathToCVAssignedData = holdingFolder+'/'+titleOfCSVWithCVAssignments+'.csv'
preppedCollection_wSpatialFolds = pd.read_csv(localPathToCVAssignedData)
...
classDfSorted.to_csv('output/'+today+'_'+classProperty+'_grid_search_results_wMEM.csv', index=False)
...
predObs_df.to_csv('output/'+today+'_'+classProperty+'_pred_obs_wMEM.csv')
