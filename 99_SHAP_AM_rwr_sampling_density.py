...
if __name__ == '__main__':
    ...
    with poolcontext(NPROC) as pool:
        try:
            with np.load('shap_values_AM_rwr_samplingdens.npz') as data:
            ...
            np.savez('shap_values_AM_rwr_samplingdens.npz', *shap_values_list)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('figures/shap/'+today+'_arbuscular_mycorrhizal_rwr_samplingdens_shap_summary_plots_full.png', dpi=300)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('figures/shap/'+today+'_arbuscular_mycorrhizal_rwr_samplingdens_shap_summary_plots_projectRemoved.png', dpi=300)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('figures/shap/'+today+'_arbuscular_mycorrhizal_rwr_samplingdens_shap_summary_plots_projectGrouped.png', dpi=300)
    ...
    # Write to file
    df_mean_shap_values.to_csv('figures/shap/'+today+'_'+'arbusucular_mycorrhizal_rwr_samplingdens_mean_shap_values.csv', index=False)
