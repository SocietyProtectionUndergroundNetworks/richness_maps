...
def pipeline(classProperty):
    ...
    rawPointCollection = rawPointCollection.loc[:,~rawPointCollection.columns.duplicated()]
    ...
    try:
        ...
        # Try printing first item of grid search, to prompt error if it's not yet exported
        len(grid_search_results.first().getInfo())

    # If grid search isn't yet performed
