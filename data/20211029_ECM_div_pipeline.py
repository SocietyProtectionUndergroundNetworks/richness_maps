...
####################################################################################################################################################################
# Import the raw CSV
rawPointCollection = pd.read_csv('data/20211029_ECM_diversity_data_sampled.csv', float_precision='round_trip')
...
# 95% percentile cut off
pct_cutoff = rawPointCollection[classProperty].quantile(0.95)
rawPointCollection = rawPointCollection[rawPointCollection[classProperty] <= pct_cutoff]
