...
guildList = ['ectomycorrhizal','arbuscular_mycorrhizal']
...
def pipeline(guild):
	...
	projectFolder = '000_SPUN_GFv4/' + guild
	...
	####################################################################################################################################################################
	# Import raw data
	rawPointCollection = pd.read_csv('data/20221117_GFv4_richness_rarefied_sampled.csv', float_precision='round_trip')
