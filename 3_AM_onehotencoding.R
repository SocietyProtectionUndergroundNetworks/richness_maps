...
# Load data
df <- fread('/Users/johanvandenhoogen/SPUN/richness_maps/data/20240610_AMF_sampled_outliersRemoved.csv') %>% 
...
df_final <- df_onehot %>% left_join(., fread('/Users/johanvandenhoogen/SPUN/richness_maps/data/20240610_AMF_sampled_outliersRemoved.csv') %>% 
                                      select(-all_of(projectVars)), by = 'sample_ID')

# Write to file
fwrite(df_final, '/Users/johanvandenhoogen/SPUN/richness_maps/data/20240610_AMF_sampled_outliersRemoved_onehot.csv')
