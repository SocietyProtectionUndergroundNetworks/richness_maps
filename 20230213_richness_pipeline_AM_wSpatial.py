...
classDfSorted.to_csv('output/'+today+'_'+classProperty+'_grid_search_results_wSpatialPreds.csv', index=False)
...
predObs_df.to_csv('output/'+today+'_'+classProperty+'_pred_obs_wSpatialPreds.csv')
