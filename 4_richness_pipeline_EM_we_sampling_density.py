...
projectFolder = '000_SPUN_GFv4_10/' + guild + '_we_wSamplingDensity'
...
titleOfCSVWithCVAssignments = guild+'_'+classProperty+"_training_data"
...
bootstrapSamples = guild+'_'+classProperty+'_bootstrapSamples'
