...
points = ee.FeatureCollection("users/johanvandenhoogen/000_SPUN_GFv4_12/ectomycorrhizal/ectomycorrhizal_richness_pred_obs")
...
BANDS = ['sample_id', 'ectomycorrhizal_richness', 'ectomycorrhizal_richness_Predicted']
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("output/20250204_ectomycorrhizal_richness_pred_obs.csv")
