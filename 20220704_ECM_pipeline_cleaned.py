...
try:
	...
	if log_transform_classProperty == True:
			predObs_wResiduals = predObs_wResiduals.map(lambda f: f.set('AbsResidual', ee.Number(f.get('AbsResidual'))
...
# Write to file
if log_transform_classProperty == True:
	predObs_df.to_csv('output/20220714_'+classProperty+'_pred_obs_zeroInflated_'+setup+'_logTransformed'+'.csv')

if log_transform_classProperty == False:
	predObs_df.to_csv('output/20220714_'+classProperty+'_pred_obs_zeroInflated_'+setup+'_wo_logTransformed'+'.csv')
