...
points = ee.FeatureCollection("users/johanvandenhoogen/000_SPUN_GFv4_12/ectomycorrhizal_rwr/rwr_pred_obs")
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("output/"+today+"_ectomycorrhizal_rwr_pred_obs.csv")
