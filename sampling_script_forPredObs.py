...
# points = ee.FeatureCollection('users/johanvandenhoogen/000_SPUN_GFv4_6/arbuscular_mycorrhizal_non_log/arbuscular_mycorrhizal_richnessdistictObs_wProjectVars_wCV_folds_data').select('arbuscular_mycorrhizal_richness')
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("data/202300217_EM_predObs_sampled.csv")
