...
projectFolder = '000_SPUN_GFv4_6/' + guild + '_non_log'
...
'''
x = predObs_df[classProperty]
y = predObs_df[classProperty+'_Predicted']
...
plt.plot(x, a*x+b)    
plt.xlabel(classProperty+' Observed')
plt.ylabel(classProperty+' Predicted')
# fig = plt.get_figure()
plt.savefig('output/'+classProperty+'_predicted_observed.png', bbox_inches='tight')
...
imgExport = ee.batch.Export.image.toAsset(
    ...
    description = classProperty+'_classifiedImage_zeroInflated',
    assetId = 'users/'+usernameFolderString+'/'+projectFolder+'/'+classProperty+'_classifiedImage_zeroInflated' ,
    crs = 'EPSG:4326',
