...
points = ee.FeatureCollection("users/johanvandenhoogen/000_SPUN_GFv4_6/20230203_GFv4_EM_richness_rarefied")
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("data/20230203_GFv4_EM_richness_rarefied_sampled.csv")
