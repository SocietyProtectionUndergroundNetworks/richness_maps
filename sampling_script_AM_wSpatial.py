...
# Add spatial predictors to composite
compositeToUse = compositeToUse.addBands(AM_spatial.reproject(compositeToUse.projection()))

# Add spatial covariates to covariate list
covariateList = covariateList + ['MEM1', 'MEM10', 'MEM11', 'MEM13', 'MEM18', 'MEM19', 'MEM20', 'MEM30', 'MEM35', 'MEM37', 'MEM4', 'MEM45', 'MEM51', 'MEM52', 'MEM58', 'MEM6', 'MEM7', 'MEM8', 'MEM81', 'MEM9']
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("data/20230213_GFv4_AM_richness_rarefied_sampled_wSpatial.csv")
