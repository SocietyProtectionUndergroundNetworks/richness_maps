...
projectFolder = '000_SPUN_zeroInflated_tmp'
...
try:
	...
	if log_transform_classProperty == True:
		preppedCollection[classProperty] = np.log(preppedCollection[classProperty] + 1).copy()
...
predObs_df.to_csv('output/20220819_'+classProperty+'_pred_obs_zeroInflated_'+setup+'.csv')
