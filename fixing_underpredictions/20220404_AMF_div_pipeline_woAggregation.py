...
predObs = finalImageClassification(pred_climate_current).addBands(ee.Image.pixelLonLat().rename(['Pixel_Long', 'Pixel_Lat'])).sampleRegions(
	collection = fcOI,
...
predObs_df.to_csv('20220404_pred_obs_woAggregation.csv')
