...
points = ee.FeatureCollection("users/johanvandenhoogen/000_SPUN_GFv4_12/20250115_AMF_richness_rarefied")\
...
if __name__ == '__main__':
		...
		with poolcontext(NPROC) as pool:
				...
				results.to_csv("data/20250115_AMF_richness_rarefied_sampled.csv")
